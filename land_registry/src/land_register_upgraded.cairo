// -----------------------
// IMPORTANT
// This component is just for testing the upgradability of the contract by changing some functionalities and use it class hash as param to the update function. 
// This does not have any other use.
// -----------------------
#[starknet::contract]
pub mod LandRegistryUpgradeContract {
