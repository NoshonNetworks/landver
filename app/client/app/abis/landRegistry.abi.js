...
exports.ABI = [
    ...
    {
        name: "core::array::Span::<land_registry::interface::land_register::Land>",
        type: "struct",
        members: [
            {
                name: "snapshot",
                type: "@core::array::Array::<land_registry::interface::land_register::Land>",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                outputs: [
                    {
                        type: "core::array::Span::<land_registry::interface::land_register::Land>",
                    },
                ],
                state_mutability: "view",
            },
