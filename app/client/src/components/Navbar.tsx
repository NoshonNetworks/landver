            ...
            {!address && (
                <div className="flex justify-end items-center relative w-full md:w-2/6 gap-2">
                    <button
                        ...
                        className="text-white hover:scale-95 transition-all bg-gradient-to-r from-[#7369e0] via-[#6E62E5] to-[#6457ed] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2 "
                    >
                        {!showWalletsModal && "Connect Wallet"}
                        {showWalletsModal && (
            ...
            {!!address && (
                <div className="flex justify-end items-center relative w-full md:w-2/6 gap-2">
                    <div className="bg-gray-100 rounded-lg flex items-center gap-1 overflow-hidden pr-2.5">
                        ...
                        <p className="text-gray-500 font-medium text-xs sm:text-sm md:text-base flex-shrink-0">
                            {data?.formatted.slice(0, 4)} {data?.symbol}
                        </p>
                    </div>
                    <div className="bg-gray-100 p-1 md:p-2 rounded-lg flex-shrink-0">
                        <div className="flex justify-center items-center flex-shrink-0">
                            <Image
                                src={"/icons/common/notifications.svg"}
                                width={30}
                                height={30}
                                alt="ether"
                            />
                    ...
                    <div className="relative cursor-pointer hover:scale-95 transition-all">
                        ...
                        <div
                            ...
                            className="absolute top-4 -right-1 w-4 h-4 md:top-6 md:-right-2 md:w-5 md:h-5"
                        >
                            <Image
                                src={
                                    "/icons/common/dropdown-arrow-purple-bubble.svg"
                                }
                                alt="ether"
                                fill
                                style={{
                        ...
                        {showUserOptions && (
                            ...
                            >
                                <p className="text-gray-500 font-semibold hover:scale-95">
                                    Disconnect
                                </p>
                            </div>
                        )}
