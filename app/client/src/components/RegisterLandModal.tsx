...
const RegisterLandModal: React.FC<RegisterLandModalProps> = ({
	isOpen,
	onClose,
	mode,
	editData,
	...
	const handleSubmit = async () => {
		try {
			...
			const landUseEnum = LandUse.find(
				(lu) => lu.name === landData.landUse
			)?.enum;
					...
					<div className="w-16 h-16 rounded-full mx-auto relative bg-[#F9F5FF] flex justify-center items-center">
						<div className="w-12 h-12 rounded-full mx-auto relative bg-[#F4EBFF] flex justify-center items-center">
							<div className="w-9 h-9 rounded-full mx-auto relative">
								<Image
									src={"/icons/sidebar/shared-selected.svg"}
									alt="ether"
									fill
									style={{
										objectFit: "cover",
					...
					<div>
						{!editData && (
							<div className="mt-4">
								...
								<input
									type="number"
									value={landData.latitude || undefined}
									onChange={(e) =>
										setLandData({
											...landData,
						...
						{!editData && (
							<div className="mt-4">
								...
								<input
									type="number"
									value={landData.longitude || undefined}
									onChange={(e) =>
										setLandData({
											...landData,
						...
						<div className="mt-4">
							<p>
								Land Use <span className="text-red-500">*</span>
							</p>
							<select
						...
						<div className="flex justify-between items-center gap-5 mt-7">
							...
							{mode === "create" && (
								<div
									...
									className={`cursor-pointer flex-1 px-5 py-1 text-white border-transparent ${
										enableSubmit
											? "bg-[#7369e0]"
											: "bg-[#E0E0E0]"
									} border-2 rounded-lg`}
