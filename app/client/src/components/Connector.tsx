...
export default function WalletConnector({}: WalletConnectorProps) {
                ...
                <div className="  bg-gray-100">
                    <div className="bg-white rounded-lg max-w-lg text-center">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 text-left">
                            A Secure Platform for Land Registration, Inspection,
                            and Validation on Starknet
                        </h3>
                        <ul className="text-left space-y-3 mb-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700 text-sm">
                                    Effortless land registration with unique
                                    property IDs.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <Check className="text-purple-600 mt-1 mr-2 rounded-full bg-purple-100 p-1" />
                                <span className="text-gray-700 text-sm">
                                    Streamlined land inspection and verification
                                    for trusted records.
                                </span>
                            </li>
                            <li className="flex items-start">
                                <Check className="text-purple-600 mt-1 mr-2 rounded-full bg-purple-100 p-1" />
                                <span className="text-gray-700 text-sm">
                                    Immutable, blockchain security for ownership
                                    and transactions.
                                </span>
                            </li>
                        </ul>
                        ...
                        >
                            {!showModal && "Choose Wallet"}
                            {showModal && <MoonLoader color="#fff" size={20} />}
                        </Button>
                    </div>
                </div>
            )}
